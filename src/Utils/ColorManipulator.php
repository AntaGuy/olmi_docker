...
class ColorManipulator
{
     ...
     *
     * @param string $hex format #ffffff, #fff, ffffff or fff
     * @return string 3 byte (000000 if input is invalid)
     */
     ...
     *
     * @param string $hex format #ffffff, #fff, ffffff or fff
     * @return array|float[] values from 0 to 1
     */
     ...
     * (check http://en.wikipedia.org/wiki/HSL_and_HSV#Hue_and_chroma)
     *
     * @param array|int[] $rgb values from 0 to 1
     * @return array values from 0 to 1
     */
     ...
     *
     * @param array|float[] $hsl values from 0 to 1
     * @return array|float[] values from 0 to 1
     */
     ...
     *
     * @param array|int[] $rgb values from 0 to 255
     * @return string hex value (#000000 - #ffffff)
     */
